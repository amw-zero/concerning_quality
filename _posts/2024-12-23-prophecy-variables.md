...
This all started from talking about the difficulty of property-based testing nondeterministic dependencies on [lobste.rs](lobste.rs) with Stevan, the author of [The sad state of propery-based testing libraries](https://stevana.github.io/the_sad_state_of_property-based_testing_libraries.html). I appreciate their views on the topic, you should read that post as well.
